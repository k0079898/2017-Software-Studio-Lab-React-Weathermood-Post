...
export default class PostItem extends React.Component {
    ...
    render() {
        const {user, id, mood, text, ts, clearVotes, cloudsVotes, drizzleVotes, rainVotes, thunderVotes, snowVotes, windyVotes} = this.props;
    ...
    handleVote(vote) {
        this.props.onVote(this.props.id, vote, this.state.user);
        this.setState({
          tooltipOpen: false
        });
    }
